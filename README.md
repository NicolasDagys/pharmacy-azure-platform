...
az cognitiveservices account purge `
  --name "pharmacy-ai-dev" `
  --resource-group "RG-pharmacy-ob-test" `
  --location "westus3"
```
...
logearse a ACR (ya logeado desde cli)
az acr login --name pharmacyacrdev


powershell.exe -ExecutionPolicy Bypass -File ./deploy.ps1

si hay que eliminar todo para volver a hacer el deploy
